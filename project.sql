...
('630e1909502e0', '630e190951ffb'),
('630e190953df9',  '630e1909545f8'),
('630e190957413',  '630e19095795a');
...
('11', 'shreyas j', 'shreyasj@gmail.com', 'maths', 'maths is tough', '2020-05-10', '10:43:31am'),
('12', 'roshan', 'roshan@gmail.com', 'java', 'java is tough', '2022-02-15', '12:50:31am');
...
('shreyasj@gmail.com', '558921841f1ec', 4, 2, 2, 0, '2015-06-23 09:31:26'),
('shakthi@gmail.com', '558920ff906b8', 4, 2, 2, 0, '2015-06-23 13:32:09'),
('sanskar@gmail.com', '558920ff906b8', 4, 2, 2, 0, '2015-06-23 14:33:04'),
('shatakshi@gmail.com', '5589222f16b93', 4, 2, 2, 0, '2015-06-23 14:49:39');
...
('5589751b749c9', 'D', '5589751b9a  9b7'),
('5589751b749c9', 'd', '5589751b9a9c9'),
('5589751bd02ec', 'autoindentation is not possible in vi editor','5589751bdadaa'),
('630e1909502e0','DML(Data Manipulation Language)','630e19b722800'),
('630e1909502e0', 'Query', '630e19b722817'),
('630e1909502e0', 'Relational Schema', '630e19b722818'),
('630e1909502e0', 'DDL(Data Definition Language)', '630e19b722819'),
('630e190953df9', 'DML(Data Manipulation Language)', '630e19b727df9'),
('630e190953df9', 'DDL(Data Definition Language)', '630e19b727e02'),
('630e190953df9', 'Query', '630e19b727e03'),
('630e190953df9', 'Relational Schema', '630e19b727e04'),
('630e190957413', 'Select name,course_id from teaches,instructor where instructor_id=course_id;', '630e19b72abca'),
('630e190957413', 'Select name, course_id from instructor natural join teaches;', '630e19b72abcf'),
('630e190957413', 'Select name, course_id from instructor;', '630e19b72abd0'),
('630e190957413', 'Select course_id from instructor join teaches;', '630e19b72abd1'),
('630e190959f88', 'select * from emp where empid = 10003;', '630e19b72beff'),
('630e190959f88', 'select empid from emp where empid = 10006;', '630e19b72bf03'),
('630e190959f88', 'select empid from emp;', '630e19b72bf04');
...
('630e170d7596d', '630e1909502e0', 'Which of the following is generally used for performing tasks like creating the structure of the relations, deleting relation?',4,1),
('630e170d7596d', '630e190953df9', 'Which of the following provides the ability to query information from the database and insert tuples into, delete tuples from, and modify tuples in the database?',4,2),
('630e170d7596d', '630e190957413', ' The given Query can also be replaced with_______:',4,3),
('630e170d7596d', '630e190959f88', 'Which of the following provides the ability to query information from the database and insert tuples into, delete tuples from, and modify tuples in the database?',4,4);
...
INSERT INTO `quiz` (`eid`, `title`, `correct`, `wrong`, `total`, `time`, `tag`, `date`) VALUES
('558920ff906b8', 'computer science', 2, 1, 2, 5,  'cs', '2015-06-23 09:03:59'),
...
('55897338a6659', 'operating system', 2, 1, 5, 10,  'os', '2015-06-23 14:54:48'),
('5589741f9ed52', 'java', 2, 1, 5, 10,  'java', '2015-06-23 14:58:39'),
('630e170d7596d', 'dbms',2,1,4,10,'dbms','2016-06-24 15:20:45');
-- --------------------------------------------------------
...
('shakthi@gmail.com', 9, '2015-06-24 03:22:38'),
('shreyas@gmail.com', 8, '2015-06-23 14:49:39'),
('sanskar@gmail.com', 4, '2015-06-23 15:12:56'),
('shatakshi@gmail.com', 3, '2015-06-23 16:11:50');
...
('shakthi', 'M', 'BMS', 'shakthi@gmail.com', 7349692007, '35ecef2f2d62ac95a6e3887d0e9cc61a'),
('shreyas', 'M', 'BMS', 'shreyas@gmail.com', 9845105479, '35ecef2f2d62ac95a6e3887d0e9cc61a'),
('sanskar','M','BMS','sanskar@gmail.com',9978266880,'35ecef2f2d62ac95a6e3887d0e9cc61a'),
('shatakshi', 'F', 'BMS', 'shatakshi@gmail.com', 9425244414, '35ecef2f2d62ac95a6e3887d0e9cc61a');
