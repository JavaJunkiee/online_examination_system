...
<div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); 
     min-height:430px;">
...
<div class="col-md-10">
<a href="mailto:shakthi.cs20@bmsce.ac.in" style="color:#000000">shakthi.cs20@bmsce.ac.in</a><br /><br />
...
<a href="https://www.bmsce.ac.in/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/bms.png" width=100 height=100 alt="Shakthi" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.bmsce.ac.in/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">SHAKTHI</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">7349692007</h4>
		<h4 style="font-family:'typo' ">shakthi.cs20@bmsce.ac.in</h4>
		<h4 style="font-family:'typo' ">BMS college of engineering</h4></div></div>
		</p>
      </div>
